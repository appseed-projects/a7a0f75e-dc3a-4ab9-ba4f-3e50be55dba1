...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-20 07:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a7a0f75e-dc3a-4ab9-ba4f-3e50be55dba1.git
$ cd a7a0f75e-dc3a-4ab9-ba4f-3e50be55dba1
```
